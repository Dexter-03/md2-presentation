...
%    \begin{center}
%		\begin{tikzpicture}
%			\node[fill=white, draw, drop shadow] {\includegraphics[height=40mm]{images/scrum-overview.png}};
%		\end{tikzpicture}
%    \end{center}
%\end{frame}
...
\begin{frame}<1-3>[plain]
	...
	\begin{center}
		\begin{tikzpicture}[
			...
			\draw[box] (67, 13) rectangle (96, 15); \node[lbl1] at (67, 14) {\scriptsize{}Location \& maps};
			\draw[box] (50, 16) rectangle (88, 18); \node[lbl1] at (50, 17) {\scriptsize{}Communication across apps};
			\draw[box] (50, 19) rectangle(96, 21); \node[lbl1] at (50, 20) {\scriptsize{}Continuous integration};
			...
			\draw[box] (15, 31) rectangle (50, 33); \node[lbl2] at (50, 32) {\scriptsize{}Infrastructure}; % infrastructure
			
			\draw[box] (1, 34) rectangle (50, 36); \node[lbl2] at (50, 35) {\scriptsize{}DSL tests (legacy)}; %DSL tests legacy
			\draw[box] (1, 37) rectangle (41, 39); \node[lbl2] (bwf) at (41, 38) {\scriptsize{}Basic workflow}; % basic workflow
			\draw[box] (1, 40) rectangle (15, 42); \node[lbl2] at (15, 41) {\scriptsize{}Conditionals in reference model}; % conditionals			
			
			\visible<2>{
				\node[overlay, align=center, right = 0cm of bwf, ellipse callout, drop shadow, fill=white, draw, callout absolute pointer = {(bwf)}] (popup) {
					\scriptsize{}Reference implementation\\
					\scriptsize{}Preprocessor\\
