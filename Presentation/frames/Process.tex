   ...
   \frametitle{Scrum Board}
       \begin{center}   
   	    \begin{tikzpicture}
   	       ...
   	       \node [above] at (1,0) {\small{\textbf{User Story}}};
   	       \node [above] at (1,-1) {\small{Story 1}};
   	       \node [above] at (1,-1.3) {\tiny{responsible: Malte}};
   	       \node [above] at (1,-2) {\small{Story 2}};
   	       \node [above] at (1,-2.3) {\tiny{responsible: Jan}};
   	       
   	       \draw[-, lightgray] (4,0.5) -- (4,-3);
   	       \node [above] at (3,0) {\small{\textbf{Todo}}};
   	       \node [above] at (3,-1) {\small{Story Cards}};
   	       \node [above] at (3,-1.3) {\tiny{Card1, Card2, ...}};
   	       \node [above] at (3,-2) {\small{Story Cards}};
   	       \node [above] at (3,-2.3) {\tiny{Card1, Card2, ...}};
   	       
   	       \draw[-, lightgray] (6,0.5) -- (6,-3);
   	       \node [above] at (5,0) {\small{\textbf{In Progress}}};
   	       \node [above] at (5,-1) {\small{Card3}};
   	       
   	       \draw[-, lightgray] (8,0.5) -- (8,-3);
   	       \node [above] at (7,0) {\small{\textbf{In Review}}};
   	       \node [above] at (7,-2) {\small{Card4}};
   	       
   	       \node [above] at (9,0) {\small{\textbf{Done}}};
   	       \node [above] at (9,-1) {\small{Card5}};
   	       \node [above] at (9,-2) {\small{Card6}};
